		...
		switch (percent) {
		    ...
		    case 2:
		    	 if ( money >= 800 && money <= 1999){
					...
					if (money > 1999){
					$("#profitDaily").text("Max: $1999");
					$("#profitTotal").text("Max: $1999");
					$("#profitPercent").text("Max: $1999");
					$("#profitNet").text("Max: $1999");
				}
		   
		        break;
		    case 3:
		    	 if ( money >= 2000 && money <= 4999){

		        	var profitDaily = money / 100 * 150;
					var profitDaily = profitDaily.toFixed(2);
					var profitTotal = money / 100 * 150 * 7;
					var profitTotal = profitTotal.toFixed(2);
					...
					$("#profitDaily").text("Min: $2000");
					$("#profitTotal").text("Min: $2000");
					$("#profitPercent").text("Min: $2000");
					$("#profitNet").text("Min: $2000");
				}
					if (money > 4999){
		    ...
		    case 4:
		    	 if ( money >= 5000 && money <= 100000){
					...
					var profitDaily = profitDaily.toFixed(2);
					var profitTotal = money / 100 * 300 * 5;
					var profitTotal = profitTotal.toFixed(2);
					...
					if (money > 100000){
					$("#profitDaily").text("Min: $100000");
					$("#profitTotal").text("Min: $100000");
					$("#profitPercent").text("Min: $100000");
					$("#profitNet").text("Min: $100000");
				}
